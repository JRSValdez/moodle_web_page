...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Mobile app HTML landing page template to help you build a great online presence for your app which will convert visitors into users"
    />
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <span class="nav-item social-icons">
          <span class="fa-stack">
            <a href="https://facebook.com/romasolutionsSV" target="_blank">
            ...
            <div class="text-container mt-5">
              <div class="row">
                <div class="col-md-6 offset-md-3 text-center">
                  <h2>Contactanos</h2>
                  <h4>Realizamos tu cotización gratis</h4>
                </div>
              </div>
              <div class="row">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="footer-col">
              <h4>MISIÓN</h4>
              <p>
                Diseñar, implementar y proporcionar soluciones informáticas que
                contribuyan al desarrollo de la sociedad, utilizando
                herramientas tecnológicas para solventar los problemas de la
                industria moderna.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="footer-col middle">
              <h4>VISIÓN</h4>
              <p>
                Ser una empresa líder en desarrollo e implementación de
                tecnologías de última generación a nivel nacional e
                internacional adaptándonos a las cambiantes condiciones de
                mercado y a las demandas o necesidades de nuestros clientes.
              </p>
            </div>
          </div>
          <!-- end of col -->
    ...
    <div class="copyright">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <p class="p-small">
              Copyright © 2020 ROMA Solutions - All rights reserved
            </p>
          </div>
          <!-- end of col -->
        </div>
